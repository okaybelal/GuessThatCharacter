...
export const characters: Character[] = [
  ...
  { id: "hermione", name: "Hermione Granger", source: "Harry Potter", emoji: "📚", color: "#8b0000", attributes: { isHuman: true, isMale: false, hasSuperpowers: true, isVillain: false, wearsCostume: true, isAnimated: false, fromMovie: true, hasFacialHair: false, isTeenOrYounger: true, wieldsWeapon: true } },
  ...
  { id: "daenerys", name: "Daenerys Targaryen", source: "Game of Thrones", emoji: "🐉", color: "#c9a227", attributes: { isHuman: true, isMale: false, hasSuperpowers: false, isVillain: false, wearsCostume: false, isAnimated: false, fromMovie: false, hasFacialHair: false, isTeenOrYounger: false, wieldsWeapon: false } },
  ...
  { id: "aang", name: "Aang", source: "Avatar: The Last Airbender", emoji: "🌪️", color: "#e8a33d", attributes: { isHuman: true, isMale: true, hasSuperpowers: true, isVillain: false, wearsCostume: false, isAnimated: true, fromMovie: false, hasFacialHair: false, isTeenOrYounger: true, wieldsWeapon: false } },
];
